...
<title>Smart Arch_AI | معماری ایرانی و هوش مصنوعی</title>
<meta name="description" content="عرشیام، دانشجوی معماری و علاقه‌مند به هوش مصنوعی. نمونه کارها و مهارت‌ها.">
<style>
body { font-family: Tahoma, sans-serif; background:#f4f4f4; margin:0; padding:0; }
header { background:#333; color:#fff; padding:20px; text-align:center; }
header h1 { font-size:2rem; }
nav { display:flex; justify-content:center; background:#444; padding:10px; flex-wrap:wrap; }
nav a { color:#fff; margin:5px 15px; text-decoration:none; }
nav a:hover { text-decoration:underline; }
.container { display:flex; flex-direction:column; align-items:center; padding:20px; }
.content { width:90%; max-width:1200px; margin-bottom:40px; padding:15px; background:rgba(255,255,255,0.7); border-radius:10px; }
...
.instagram-link { display:inline-block; margin-bottom:20px; color:#E1306C; font-weight:bold; font-size:18px; text-decoration:none; }
...
<p>عرشیا، دانشجوی مقطع کارشناسی در رشته‌ی معماری حرفه‌ای هستم. دلگرو هنر و دانش معماری اصیل ایرانی دارم و با شور و شوق به زیبایی‌های این میراث می‌نگرم. علاقه‌مند به هوش مصنوعی و ترکیب آن با معماری ایرانی هستم.</p>
</section>
